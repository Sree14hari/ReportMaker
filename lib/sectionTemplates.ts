...
export const sectionTemplates: Record<SectionType, SectionTemplate> = {
  ...
  'declaration': {
    ...
    defaultContent: `<p style="text-align: justify;">We, the undersigned, hereby declare that the project report titled <strong>"{{title}}"</strong>, submitted in partial fulfillment of the requirements for the award of the degree of <strong>{{degree}}</strong> under <strong>{{universityName}}, Kerala</strong>, is a bona fide work carried out by us under the supervision of <strong>{{guideName}} ({{guideDesignation}}, Department of {{department}})</strong>. This submission represents our ideas in our own words. Wherever ideas or words of others have been included, we have appropriately cited and referenced the original sources. We affirm that we have adhered to the principles of academic honesty and integrity and have not misrepresented or fabricated any data, idea, fact, or source in this submission. We understand that any violation of the above will result in disciplinary action by the institute and/or the University and may also invoke legal consequences from the original sources that have not been properly cited or for which prior permission has not been obtained. We further declare that this report has not previously formed the basis for the award of any degree, diploma, or similar title from any other university or institution.</p>`,
  },
  'acknowledgement': {
